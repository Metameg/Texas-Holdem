...
class Deck(object):
    ...
    def draw_flop(self):
        ...
        card1 = self.select_card(True)
        card2 = self.select_card(True)
        card3 = self.select_card(True)
    ...
    def draw_one(self):
        ...
        card = self.select_card(True)

        # card_image = Image.open(card)

        # resized_card = self.resize_image(card_image, self.temp_card_images)
